OC.L10N.register(
    ...
    "Problem in OAuth third step" : "在OAuth第三步出现问题",
    "Problem in OAuth first or second step" : "在OAuth的第一或第二步中出现问题",
    "Twitter home timeline" : "Twitter主页时间线",
    "Twitter notifications" : "Twitter通知",
    "Twitter user timeline" : "Twitter用户时间线",
    "Impossible to decode response" : "无法解码响应",
    "Invalid return value in OAuth step 1" : "在OAuth的第一步中返回无效值",
    ...
    "Consumer key" : "网站密钥",
    "Consumer key of your Twitter application" : "您Twitter应用的的密钥",
    "Consumer secret" : "网站密码",
    ...
    "Twitter admin options saved" : "已保存Twitter管理员选项",
    ...
    "Connect to Twitter" : "连接到Twitter",
    "Connected as {user}" : "以{user}身份连接",
    "Disconnect from Twitter" : "断开Twitter连接",
    ...
    "Defined by an administrator: \"@{name}\"" : "由管理员定义：“@{name}”",
    "Successfully connected to Twitter!" : "成功连接到了Twitter！",
    "Twitter OAuth error:" : "Twitter OAuth错误：",
    "Nextcloud Twitter integration on {ncUrl}" : "Nextcloud Twitter集成在 {ncUrl}",
    "Twitter options saved" : "已保存Twitter选项",
    ...
    "No Twitter account connected" : "未连接至Twitter账号",
    "Error connecting to Twitter" : "连接到Twitter时出错",
    "No Twitter notifications!" : "无Twitter通知",
    "Failed to get Twitter notifications" : "获取Twitter通知失败",
    "{nb} follow requests" : "{nb}关注请求",
    "System" : "系统",
    "No tweets!" : "没有推文",
